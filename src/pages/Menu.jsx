...
function Menu() {
  return (
    ...
    {/* left div */}
         ...
         <div className=' flex items-center gap-4 '>
          ...
          <div className='flex items-center  justify-around gap-4 '>
            <div className='flex items-center gap-3  cursor-pointer'>
                ...
                <div>
                  <p className='text-xl text-gray-100 font-medium'>Customer Name</p>
                  <p className='text-sm text-gray-400'>Table No:</p>
                </div>
              </div>
     ...
     {/* Right div  */}
     <div className='flex-1  bg-neutral-950 mt-4 mr-3 h-195 mb-12 rounded-lg pt-2'>
      {/* customer info */}
      <CustomerInfo/>
